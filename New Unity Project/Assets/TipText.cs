...
{
    string[] tipArray = new string[]{"... you can press spacebar to activate a portal and go to the shop's website?", "... Grace Bros (the founder of Model Moxham) was established in 1885? That's over 100 years old!", "... you can explore Model Moxham in the game through some of the exits in Broadway?", "... the globe above Model Moxham used to say 'GRACE' on it?", "... you can press WASD or the arrow keys to move about in the game?"};
